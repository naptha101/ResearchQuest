...
import { FileText, BookOpen, ArrowRight, Sparkles, Zap, Loader2, PenTool } from 'lucide-react';
...
export default function Page() {
  ...
  const handleCreateFolderandRedirecting=async (type)=>{
    setLoading(true)
    try{
        if(type==='pdf'){
        ...
        console.log(res)
        if(res){
     router.push('/citation-generator/upload-research-pdf')
      ...
      router.push('/citation-generator/url-research-papers')

    }else{
     router.push('/citation-generator/url-internet-articles')
                ...
                `}>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="text-center">
                      <button onClick={()=>{handleCreateFolderandRedirecting(section.type)}} className={`
