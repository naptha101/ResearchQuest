...
import { articleDetails, finalCitatioGeneration, researchPaperUrl } from "@/app/Services/Citation-Service"
...
const handleSubmit = async () => {
    ...
    try{
      const response=await articleDetails({
        article_url: url,
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Generate accurate citations from Article URLs with professional formatting
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-4 text-sm text-gray-700">
          <div>
            ...
            <ul className="list-disc list-inside">
              {jsonInput.article_authors.map((author, index) => (
          ...
          <div>
            ...
            <p><span className="font-medium">Year:</span> {jsonInput.publication_date}</p>
            <p><span className="font-medium">Pages:</span> {jsonInput.pages}</p>
          <p><span className="font-medium">Access Date:</span> {jsonInput.access_date || "—"}</p>

            <p><span className="font-medium">Publisher:</span> {jsonInput.publisher || "—"}</p>
            <p>
